...
!
      use idea_iau_hwm, only : nxa_hwm, nya_hwm, nza_hwm
      implicit none
      integer, intent(in) ::  nz,  me
!                                                   
      integer, dimension(latr)       :: global_lats_r, lonsperlar
!
      real(kind=kind_io8), dimension(nxa_hwm,nya_hwm,nza_hwm) :: Uanl
...
!
      ...
      !print *, 'Gar VAY-me- iau_split 1', me,shape(Uanl)
      !print *, 'Gar VAY-me- iau_split 2', me,shape(Ua)
...
!
     ...
     & me, Uanl, Ua)
      ...
      use idea_iau_hwm, only : nxa_hwm, nya_hwm
      implicit none
      integer, intent(in) :: me
!                                            
      integer, dimension(latr)       :: global_lats_r, lonsperlar
      real, dimension(nxa_hwm,  nya_hwm)     :: Uanl
