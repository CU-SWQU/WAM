...
!     $ ='/scratch3/NCEPDEV/swpc/scrub/Valery.Yudin/NC_DAS48/'
      ...
      character(len=99),parameter::nml_g='/glade/work/garimam/gdasnc_in'
      integer           :: idaygdas
!      
      integer  :: irec_gdas
      integer  :: ihr
...
!      
      ...
      open(unit=155, file=trim(nml_g), status='old' )
      read(155, gdasnc_nl, iostat=ierr)  
      if (ierr .ne. 0) then
      print *, 'VAY-GDAS:-nml_gdas', trim(nml_g)
